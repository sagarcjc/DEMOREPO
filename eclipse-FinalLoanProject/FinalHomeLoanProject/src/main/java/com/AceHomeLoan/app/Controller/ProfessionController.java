...
public class ProfessionController {
    ...
    public String saveProfessionService(@RequestPart("profession") String profession,
    		                             @RequestPart ("psalarySlips") MultipartFile file
    		                             ) throws IOException
	{
		...
		try {
			...
			p.setPsalarySlips(file.getBytes());
